...
contextBridge.exposeInMainWorld("electron-api", {
    ...
    printTicketAbonoEscPos: (data) => ipcRenderer.invoke('print-ticket-abono-escpos', data),
    printTicketCorteEscPos: (data) => ipcRenderer.invoke('print-ticket-corte-escpos', data),
